		        ...
		        <div class="app-header-content"> 
		            ...
		            <div class="app-utilities col-auto">
			            ...
			            <div class="app-utility-item">
				            <a href="settings.html" title="Settings"><i class="fas fa-cog fa-lg"></i>
					            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="assets/images/app-logo.svg" alt="logo"><span class="logo-text">INTERSTELLER</span></a>
